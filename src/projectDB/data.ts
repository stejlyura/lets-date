...
import Dora from '@/assets/img/Dora.jpg'
import Isabella from '@/assets/img/Isabella.jpg'
import Karina from '@/assets/img/Karina.jpg'
import Komee from '@/assets/img/Komee.jpg'
import Leila from '@/assets/img/Leaila.jpg'
...
import Ryta from '@/assets/img/Ryta.jpeg'
...
export const projectBD: userData[] = [
    ...
    {data_id: 10, fname: 'Komee', age: 20, isLike: true, mainImg: Komee, isActive: true, range: 35},
    {data_id: 11, fname: 'Asya', age: 23, isLike: true, mainImg: Asya, isActive: false, range: 95},
    {data_id: 12, fname: 'Sophie', age: 20, isLike: true, mainImg: Sophie, isActive: false, range: 72},
    {data_id: 13, fname: 'Nastya', age: 19, isLike: true, mainImg: Nastya, isActive: false, range: 79},
    {data_id: 14, fname: 'Leila', age: 20, isLike: true, mainImg: Leila, isActive: false, range: 45},
    {data_id: 15, fname: 'Dora', age: 21, isLike: true, mainImg: Dora, isActive: false, range: 77},
    {data_id: 16, fname: 'Ryta', age: 20, isLike: true, mainImg: Ryta, isActive: false, range: 52},
    {data_id: 17, fname: 'Dana', age: 25, isLike: true, mainImg: Dana, isActive: false, range: 68},
    {data_id: 18, fname: 'Karina', age: 26, isLike: true, mainImg: Karina, isActive: false, range: 73},
